...
const scenarios: Scenario[] = [
  ...
  { id: 91, name: "iframe boundary fails honestly", html: `<iframe src="/child-91"></iframe>`, run: async p => expect(["CONTROL_INVENTORY_EMPTY","TARGET_NOT_FOUND","NO_CAPABILITY_COMPATIBLE_CONTROL"]).toContain(await failureCode(resolveTarget(p,target("Inside iframe")))) },
