...
export class PraxisAdapter implements PraxisTransactionAdapter<PraxisGroundedTarget> {
  ...
  async observe() { /* Observation is bounded by the Praxis grounding engine. */ }
