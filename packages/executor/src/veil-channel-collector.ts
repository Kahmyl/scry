import type { PrivacyCollector, PrivacyPreparation } from "./veil-runtime-coordinator.js";
import type { PrivacyFailure, SafeResumeBoundary } from "@scry/contracts";

export type VeilChannelCollectorState = "active" | "prepared" | "suspended" | "isolated" | "sealed" | "finalized";
...
export class VeilChannelCollector implements PrivacyCollector {
  ...
  isCaptureSuppressed(): boolean { return this.current !== "active"; }
