...
const origin = z
  .string()
  .url()
  .refine((value) => new URL(value).origin === value, "must be a canonical origin");
...
export const veilPolicyControlsSchema = z
  .object({
...
export const veilPolicyPreferencesSchema = z
  .object({
...
export const veilPolicySnapshotSchema = z
  .object({
...
export const veilContextSchema = z
  .object({
    userId: identifier,
...
export const veilLeaseRequestSchema = z
  .object({
...
export const veilDecisionSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilCapabilityLeaseSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilVisualRegionSchema = z
  .object({
    regionId: identifier,
...
export const veilCapturePermitSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilVideoSegmentPermitSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilVideoMaskCheckpointSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
    segmentId: identifier,
...
export const veilVideoSegmentFinalizationSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
    segmentId: identifier,
...
export const veilCollectorPhaseSchema = z.enum([
  "prepare",
  "suspend",
  "isolate",
  "resume",
...
export const veilCollectorManifestSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
  ...
  .strict();
export const veilCollectorAcknowledgementSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
    collectorId: identifier,
...
export const veilRuntimeTransitionSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
    sequence: z.number().int().positive(),
...
export const veilEvidenceManifestSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilFailureSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilPreferenceUpdateSchema = z
  .object({
    ...
    reasonCode: z.enum([
      ...
      "VEIL_AGENT_REQUESTED_PRIVACY",
      "VEIL_POLICY_REMEDIATION",
    ]),
  })
  .strict();

export const veilPreferenceRecordSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
...
export const veilFindingSchema = z
  .object({
    code: z.string().regex(/^VEIL_[A-Z0-9_]+$/),
...
export const veilRunObservationSchema = z
  .object({
    schemaVersion: z.literal(VEIL_CONTRACT_VERSION),
